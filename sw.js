const CACHE='meu-ingles-v14';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./upgrade-v6.js','./live-v7.css','./live-config.js','./live-v7.js','./hard-v8.js','./home-v10.css','./home-v10.js','./coach-v11.css','./coach-v11.js','./gemini-voice-v12.js','./gemini-chat-v12.js','./course-v12.css','./course-v12.js','./fixes-v13.css','./fixes-v13.js'];
...
async function injectUpgrade(response){
  ...
  if(!text.includes('fixes-v13.css')) text=text.replace('</head>','<link rel="stylesheet" href="./fixes-v13.css?v=13"></head>');
  ...
  if(!text.includes('fixes-v13.js')) text=text.replace('</body>','<script src="./fixes-v13.js?v=13"></script></body>');
